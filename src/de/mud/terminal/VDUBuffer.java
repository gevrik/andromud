 ...
 * @version $Id: VDUBuffer.java,v 1.3 2010/03/18 23:27:43 zhang42 Exp $
 */
public class VDUBuffer {

	/** The current version id tag */
	public final static String ID = "$Id: VDUBuffer.java,v 1.3 2010/03/18 23:27:43 zhang42 Exp $";
	...
	public synchronized void insertLine(int l, int n, boolean scrollDown) {
		...
		if (scrollDown) {
			...
			try {
				...
				if (top > 0) {
					System.arraycopy(charArray, oldBase, cbuf, newScreenBase,
							top);
				...
				System.err.println("screenBase=" + screenBase + ", windowBase="
						+ windowBase);
				System.err.println("newScreenBase=" + newScreenBase
						+ ", newWindowBase=" + newWindowBase);
